...
/**
 * @file
 * Contains \Drupal\flexslider\Form\OptionsetForm.
 */
...
class OptionsetForm extends EntityForm {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $default_optionset = \Drupal::config('flexslider.flexslider_options.default');
    $default_options = $default_optionset->get('options');
    ...
    $form['id'] = array(
      ...
      '#machine_name' => array(
        'exists' => '\Drupal\flexslider\Entity\Optionset::load',
      ),
  ...
  public function save(array $form, FormStateInterface $form_state) {
    /** @var \Drupal\flexslider\Entity\Optionset $optionset */
    $optionset = $this->entity;
